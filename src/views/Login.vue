<template>
  <div class="max-w-screen-sm mx-auto px-4 py-10">
    ...
    <form @submit.prevent="login" class="p-8 flex flex-col bg-light-grey rounded-md shadow-lg">
      ...
      hover:text-nits-green" type="submit">Entra</button>

      <router-link class="text-sm mt-6 text-center" :to="{name:'Register'}"> No tens compte? <span class="text-nits-green">Registra't</span></router-link>
    </form>
  </div>
</template>
